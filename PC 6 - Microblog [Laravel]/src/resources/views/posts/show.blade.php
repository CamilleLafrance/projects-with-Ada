      ...
      <div class='w-full'>
        <div class="flex flex-row px-2 py-3 mx-3 mt-2">
          ...
          <div class="flex flex-col mt-1 mb-2 ml-4">
            <div class='text-sm font-semibold text-gray-600'>{{$post->user->name}}</div>
        ...
        <div class='px-2 mx-3 mt-6 text-sm font-medium text-gray-400 mb-7'><img class="rounded" src={{$post->img_url}}></div>
        <div class='px-2 mx-3 mb-2 text-lg font-medium text-gray-600'>{{$post->description}}</div>
        <div class='px-2 mx-3 mb-6 text-sm font-light text-gray-500'>{{$post->body}}</div>
